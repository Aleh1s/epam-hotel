...
import ua.aleh1s.hotelepam.database.querybuilder.aggregatefunc.AggregateFunction;
...
import ua.aleh1s.hotelepam.database.querybuilder.impl.DeleteQueryBuilder;
