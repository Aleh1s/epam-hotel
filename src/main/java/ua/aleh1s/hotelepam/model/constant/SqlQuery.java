...
public class SqlQuery {
    ...
    public static final String RESERVATION_SELECT_BY_CUSTOMER_ID_PAGEABLE_SORT_BY_CREATED_AT = "select * from \"reservation\" where customer_id = ? and status != 6 order by created_at desc offset ? limit ?";
